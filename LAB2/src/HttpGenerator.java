public class HttpGenerator {
  ...
  public static String getStartRes() {
    ...
    sb.append(
        "<form action='#' method='post'><p>Im thinking of a number between 0 and 100.</p><input type='text' name='guessedNumber' /><input type='submit' value='submit' /></form>");
    sb.append("</body></html>");
